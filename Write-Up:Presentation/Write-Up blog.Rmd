---
title: "Visualizing Armed Conflict"
...
Our application, shown above, offers a tool to explore the relationship between quality of life and armed conflict in various countries. Although we don't think we can answer in full the questions above, our application offers a glimpse to what those answer can look like for various countries relative to each other. In addition, we are interested in evaluating whether there is a difference in locations of armed conflics in western countries versus the global south and the network of warring sides. We intergrated the wealth of information available for armed conflicts and various findings on coutry-level data to provide a synthesized view of how armed conflicts affects various nations. 
...
Using this preliminary results we move on to the "plot" tab to see how the various indicators for quality of life affect the countries at war. We observe that westernized countries, exemplified by the United State and the United Kingdom, score pretty high in most of the variables. They have a above average SES score even in years following huge conflicts. On the other hand, the India and Myanmar have SES scores below 25 and showing no trends of growth over the last 25 years (shown in photo below). In other indicators such as health expenditure, the trends are similar as previosuly described. 

One special indicator of interest is the refugee origin/asylum. We see that refugee origin is low, close to zero, for various westernized coutnries. But we see this number fluctuate for other war-torn coutnries. The opposite effect is seen when looking at refugee asylum. Most refugees turn to western countries when seeking asylum. This is particularly intereting because the western countries are in as many conflicts, if not more, than the countries in which the indivuals are coming from. But because the conflits aren't occuring in those nations directly, the location is seen as safer.

![SES indicator (score from 1 to 100)](SES-score.png)  


![Refugee Origin (% of the population)](refugee-origin.png)  

![Refugee Asylum (% of the population)](refugee-asylum.png)  
