...
By merging three different data sets, we were able to create a shiny app to address a couple of key questions: How do various governments and entities connect in their war history? How do war-torn countries, countries in which the conflict occur, differ in statistics from western countries? We found that in a variation of network it is possibile to include all historical entities that have been at war. In addition, a majority of conflicts occur in the global south, as opposed to the western countries who are also involved in hundreds of conflicts.
