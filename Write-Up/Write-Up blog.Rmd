...
conflict.data %>% select(1:4) %>% head(5)
```


### Wrangling

Using the three seperate sets, we were able to construct a comprehsnive data set of all necessary information using data wrangling techniques.
