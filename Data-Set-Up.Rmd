...
library(readr)
SES_data <- read_csv("~/Documents/SeniorSZN/MA154/Project/ma154-project21-teamconflict/GLOB.SES.csv")
```
...
conflict_data <- read_csv("~/Documents/SeniorSZN/MA154/Project/ma154-project21-teamconflict/ucdp-prio-acd-171.csv")
View(conflict_data)
```
