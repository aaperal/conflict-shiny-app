...
Our application, explored through the tabs, offers a tool to answer that explores the relationship between quality of life and armed conflict in various countries. We intergrated the wealth of information available for armed conflicts and various findings on coutry-level data to provide a synthesized view of how armed conflicts affects various nations. By offering this perspective, we can observe that it severely affects countries in which the conflict takes place and the other side is left unaffected and growing.
